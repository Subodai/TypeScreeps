...
import { loadBuilderActions } from "roles/Builder";
import { loadMinerActions } from "roles/Miner";
import { loadUpgraderActions } from "roles/Upgrader";
import { Traveler } from "utils/Traveler";
import { loadCreepBasicActions } from "./creep/basicActions";
import { loadCreepEnergyActions } from "./creep/energyActions";
import { loadCreepProperties } from "./creep/memory";
import { loadCreepMineralActions } from "./creep/mineralActions";
...
export function loadCreepPrototypes(): void {
    ...
    loadCreepProperties();
    loadCreepBasicActions();
    loadCreepMineralActions();
    loadCreepEnergyActions();
    loadMinerActions();
    loadBuilderActions();
    loadUpgraderActions();
